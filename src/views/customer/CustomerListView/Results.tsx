...
const applyFilters = (customers: User[], query: string, filters: any): User[] => {
...
const applyPagination = (customers: User[], page: number, limit: number): User[] => {
...
const applySort = (customers: User[], sort: Sort): User[] => {
...
const getStatusLabel = (confirmed: boolean): JSX.Element => {
    if(confirmed){
              ...
              {paginatedCustomers.map((customer) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      >
                        <Avatar
                          ...
                          src={customer?.avatar}
                        >
                          {getInitials(customer.user_profile?.name || "-")}
                        </Avatar>
                        <div>
                          <Link
                            color="inherit"
                          ...
                          <Typography
                            ...
                            color="textSecondary"
                          >
                            {customer.user_profile?.mobileNumber}
                          </Typography>
                        </div>
                      </Box>
                    </TableCell>
                    ...
                    <TableCell>
                      {getStatusLabel(customer.confirmed)}
                    </TableCell>
                    <TableCell>
                    {customer.user_profile?.business_entity?.name || "-"}
                    </TableCell>
                    <TableCell align="right">
                      <IconButton
                        component={RouterLink}
